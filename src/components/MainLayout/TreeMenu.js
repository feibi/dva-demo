...
class TreeMenu extends Component {
  ...
  render() {
    return (
      <Menu onClick={this.handleClick}  theme="dark" defaultOpenKeys={['sub1','sub2']} selectedKeys={[this.state.current]} mode="inline">
        ...
        <SubMenu key="sub2" title={< span > <Icon type="appstore"/> < span > Navigation Two < /span></span >}>
          <Menu.Item key="5"><Link to="/users"><Icon type="bars" />Users</Link></Menu.Item>
